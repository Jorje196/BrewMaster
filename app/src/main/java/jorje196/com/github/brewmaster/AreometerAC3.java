 ...
 */
    ...
    static double getAlcoholPercent(int beginningWortT, double beginingWortG,
        int bottlingWortT, double bottlingWortG, double carbonaitionAlcConst){
        double res;
    ...
    static boolean tValidationMin(int temperature){
        return temperature >= T_MIN;
    }
    static boolean tValidationMax(int temperature){
    ...
    static boolean gValidationMin(double gravity){
        return gravity >= GRAVITY_MIN;
    }
    static boolean gValidationMax(double gravity){
